...
{
	FileInputStream fi=new FileInputStream("D:\\anilch\\stockaccounting_DDF\\testinput\\supplier.xlsx");
		...
		throws Throwable
{
	...
	FileOutputStream fos=new FileOutputStream("D:\\anilch\\stockaccounting_DDF\\testinput\\supplier.xlsx");
	wb.write(fos);
	fos.close();
}
}
